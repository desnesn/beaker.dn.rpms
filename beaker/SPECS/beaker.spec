...
* Wed Nov 25 2020 Renan Barbosa <rebarbos@redhat.com> - 28.1-1:
- new maintenance release 28.1:
  https://beaker-project.org/docs/whats-new/release-28.html#beaker-28-1

* Mon Aug 24 2020 Carol Bouchard <cbouchar@redhat.com> - 28.0-1:
- new major release 28.0:
  https://beaker-project.org/docs/whats-new/release-28.html

* Mon Mar 30 2020 Martin Styk <mastyk@redhat.com> - 27.4-1:
- new maintenance release 27.4:
  https://beaker-project.org/docs/whats-new/release-27.html#beaker-27-4

* Wed Mar 18 2020 Martin Styk <mastyk@redhat.com> - 27.3-1:
  https://beaker-project.org/docs/whats-new/release-27.html#beaker-27-3

* Wed Mar 04 2020 Martin Styk <mastyk@redhat.com> - 27.2-1:
- new maintenance release 27.2:
  https://beaker-project.org/docs/whats-new/release-27.html#beaker-27-2
  Changed python-gevent102 to python2-gevent112
  
* Wed Jan 29 2020 Martin Styk <mastyk@redhat.com> - 27.1-1:
- new maintenance release 27.1:
  https://beaker-project.org/docs/whats-new/release-27.html#beaker-27-1

* Mon Dec 09 2019 Martin Styk <mastyk@redhat.com> - 27.0-2:
- Fix dependency for lab controller

* Wed Dec 04 2019 Martin Styk <mastyk@redhat.com> - 27.0-1
- new major release 27.0:
  https://beaker-project.org/docs/whats-new/release-27.html

* Thu Oct 24 2019 Martin Styk <mastyk@redhat.com> - 26.6-1
- new maintenance release 26.6:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-6

* Tue May 21 2019 Martin Styk <mastyk@redhat.com> - 26.5-1
- new maintenance release 26.5:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-5

* Tue Apr 09 2019 Martin Styk <mastyk@redhat.com> - 26.4-1.el6bkr.hotfix.1
- Hotfix for noisy anamon in beaker-proxy (RHBZ#1697479)

* Mon Mar 25 2019 Martin Styk <mastyk@redhat.com> - 26.4-1
- new maintenance release 26.4:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-4

* Fri Jan 18 2019 Martin Styk <mastyk@redhat.com> - 26.3-1
- new maintenance release 26.3:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-3

* Wed Dec 12 2018 Martin Styk <mastyk@redhat.com> - 26.2-1
- new maintenance release 26.2:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-2

* Wed Oct 31 2018 Brendan Reilly <breilly@redhat.com> - 26.1-1
- new maintenance release 26.1:
  https://beaker-project.org/docs/whats-new/release-26.html#beaker-26-1

* Thu Oct 04 2018 Dan Callaghan <dcallagh@redhat.com> - 26.0-1
- new release 26.0: https://beaker-project.org/docs/whats-new/release-26.html

* Fri Sep 21 2018 Dan Callaghan <dcallagh@redhat.com> - 25.6-1.el6bkr.hotfix.1
- Hotfix for anamon on RHEL7.6 (RHBZ#1625234)

* Fri Aug 31 2018 Dan Callaghan <dcallagh@redhat.com> - 25.6-1
- new maintenance release 25.6:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-6

* Mon Jul 23 2018 Róman Joost <rjoost@redhat.com> - 25.5-1
- new maintenance release 25.5:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-5

* Thu Jun 07 2018 Dan Callaghan <dcallagh@redhat.com> - 25.4-1.el6bkr.hotfix.1
- Hotfix for score int coercion against Mariadb (RHBZ#1586049)

* Wed May 23 2018 Matt Tyson <mtyson@redhat.com> - 25.4-1
- new maintenance release 25.4:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-4

* Tue May 22 2018 Dan Callaghan <dcallagh@redhat.com> - 25.3-1.el6bkr.hotfix.1
- Hotfix for idle active MySQL transactions
  https://bugzilla.redhat.com/show_bug.cgi?id=1574772#c7

* Thu May 17 2018 Matt Tyson <mtyson@redhat.com> - 25.3-1
- new maintenance release 25.3:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-3

* Thu May 17 2018 Dan Callaghan <dcallagh@redhat.com> - 25.2-1.el6bkr.hotfix.1
- Hotfix for distro_tree_for_inventory() performance problem (RHBZ#1579289)

* Thu Apr 19 2018 Róman Joost <rjoost@redhat.com> - 25.2-1
- new maintenance release 25.2:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-2

* Wed Apr 11 2018 Róman Joost <rjoost@redhat.com> - 25.1-1
- new maintenance release 25.1:
  https://beaker-project.org/docs/whats-new/release-25.html#beaker-25-1

* Wed Mar 14 2018 Róman Joost <rjoost@redhat.com> - 25.0-1
- new release 25.0: https://beaker-project.org/docs/whats-new/release-25.html

* Thu Dec 14 2017 Dan Callaghan <dcallagh@redhat.com> - 24.5-1.el6eng.hotfix.1
- Hotfix for S/390 ftp:// URLs to handle initramfs larger than 32MB (RHBZ#1322235)

* Fri Oct 27 2017 Dan Callaghan <dcallagh@redhat.com> - 24.5-1
- new maintenance release 24.5:
  https://beaker-project.org/docs/whats-new/release-24.html#beaker-24-5

* Fri Sep 29 2017 Dan Callaghan <dcallagh@redhat.com> - 24.4-1
- new maintenance release 24.4:
  https://beaker-project.org/docs/whats-new/release-24.html#beaker-24-4

* Tue May 30 2017 Dan Callaghan <dcallagh@redhat.com> - 24.3-1
- new maintenance release 24.3:
  https://beaker-project.org/docs/whats-new/release-24.html#beaker-24-3

* Thu Mar 30 2017 Dan Callaghan <dcallagh@redhat.com> - 24.2-1
- new maintenance release 24.2:
  https://beaker-project.org/docs/whats-new/release-24.html#beaker-24-2

* Tue Feb 28 2017 Dan Callaghan <dcallagh@redhat.com> - 24.1-1
- new maintenance release 24.1:
  https://beaker-project.org/docs/whats-new/release-24.html#beaker-24-1

* Wed Jan 25 2017 Matt Jia <mjia@redhat.com> - 24.0-1
- new release 24.0: https://beaker-project.org/docs/whats-new/release-24.html

* Tue Nov 08 2016 Dan Callaghan <dcallagh@redhat.com> - 23.3-1
- new maintenance release 23.3:
  https://beaker-project.org/docs/whats-new/release-23.html#beaker-23-3

* Fri Sep 02 2016 Dan Callaghan <dcallagh@redhat.com> - 23.2-1
- new maintenance release 23.2:
  https://beaker-project.org/docs/whats-new/release-23.html#beaker-23-2

* Mon Aug 08 2016 Dan Callaghan <dcallagh@redhat.com> - 23.1-1
- new maintenance release 23.1:
  https://beaker-project.org/docs/whats-new/release-23.html#beaker-23-1

* Thu Jul 07 2016 Dan Callaghan <dcallagh@redhat.com> - 23.0-1
- new release 23.0: https://beaker-project.org/docs/whats-new/release-23.html

* Fri Apr 01 2016 Róman Joost <rjoost@redhat.com> - 22.3-1
- new maintenance release 22.3:
  https://beaker-project.org/docs/whats-new/release-22.html#beaker-22-3

* Tue Mar 15 2016 Dan Callaghan <dcallagh@redhat.com> - 22.2-1
- new maintenance release 22.2:
  https://beaker-project.org/docs/whats-new/release-22.html#beaker-22-2

* Mon Feb 01 2016 Dan Callaghan <dcallagh@redhat.com> - 22.1-1
- new maintenance release 22.1:
  https://beaker-project.org/docs/whats-new/release-22.html#beaker-22-1

* Thu Jan 14 2016 Dan Callaghan <dcallagh@redhat.com> - 22.0-1
- new release 22.0: https://beaker-project.org/docs/whats-new/release-22.html

* Tue Nov 17 2015 Matt Jia <mjia@redhat.com> - 21.1-2
- new maintenance release 21.2:
  https://beaker-project.org/docs/whats-new/release-21.html#beaker-21-2

* Wed Oct 21 2015 Dan Callaghan <dcallagh@redhat.com> - 21.1-1
- new maintenance release 21.1:
  https://beaker-project.org/docs/whats-new/release-21.html#beaker-21-1

* Wed Aug 26 2015 Dan Callaghan <dcallagh@redhat.com> - 21.0-1
- new release 21.0: https://beaker-project.org/docs/whats-new/release-21.html

* Tue Jul 14 2015 Dan Callaghan <dcallagh@redhat.com> - 20.2-1
- new maintenance release 20.2:
  https://beaker-project.org/docs/whats-new/release-20.html#beaker-20-2

* Fri May 08 2015 Dan Callaghan <dcallagh@redhat.com> - 20.1-1
- new maintenance release 20.1:
  https://beaker-project.org/docs/whats-new/release-20.html#beaker-20-1

* Mon Apr 20 2015 Dan Callaghan <dcallagh@redhat.com> - 20.0-1
- new release 20.0: https://beaker-project.org/docs/whats-new/release-20.html

* Thu Apr 16 2015 Dan Callaghan <dcallagh@redhat.com> - 19.3-2
- fixed selenium requirement for Fedora

* Tue Mar 17 2015 Dan Callaghan <dcallagh@redhat.com> - 19.3-1
- new maintenance release 19.3:
  https://beaker-project.org/docs/whats-new/release-19.html#beaker-19-3

* Thu Jan 15 2015 Dan Callaghan <dcallagh@redhat.com> - 19.2-1
- new maintenance release 19.2:
  https://beaker-project.org/docs/whats-new/release-19.html#beaker-19-2

* Wed Dec 17 2014 Dan Callaghan <dcallagh@redhat.com> - 19.1-1
- new maintenance release 19.1:
  https://beaker-project.org/docs/whats-new/release-19.html#beaker-19-1

* Tue Nov 25 2014 Dan Callaghan <dcallagh@redhat.com> - 19.0-1
- new release 19.0: https://beaker-project.org/docs/whats-new/release-19.html

* Fri Oct 24 2014 Amit Saha <asaha@redhat.com> - 0.18.4-1
- new maintenance release 0.18.4:
  https://beaker-project.org/docs/whats-new/release-0.18.html#beaker-0-18-4

* Fri Oct 17 2014 Dan Callaghan <dcallagh@redhat.com> - 0.18.3-1
- new maintenance release 0.18.3:
  https://beaker-project.org/docs/whats-new/release-0.18.html#beaker-0-18-3

* Tue Oct 07 2014 Dan Callaghan <dcallagh@redhat.com> - 0.18.2-1
- new maintenance releases 0.18.2:
  https://beaker-project.org/docs/whats-new/release-0.18.html#beaker-0-18-2

* Fri Sep 12 2014 Dan Callaghan <dcallagh@redhat.com> - 0.18.1-1
- new maintenance releases 0.18.1:
  https://beaker-project.org/docs/whats-new/release-0.18.html#beaker-0-18-1

* Thu Sep 04 2014 Dan Callaghan <dcallagh@redhat.com> - 0.18.0-1
- new release 0.18.0:
  https://beaker-project.org/releases/#beaker-0.18
  https://beaker-project.org/docs/whats-new/release-0.18.html

* Thu Aug 14 2014 Amit Saha <asaha@redhat.com> - 0.17.3-1
- new maintenance release 0.17.3:
  https://beaker-project.org/docs/whats-new/release-0.17.html#beaker-0-17-3

* Tue Jul 29 2014 Dan Callaghan <dcallagh@redhat.com> - 0.17.2-1
- new maintenance release 0.17.2:
  https://beaker-project.org/docs/whats-new/release-0.17.html#beaker-0-17-2

* Fri Jul 18 2014 Dan Callaghan <dcallagh@redhat.com> - 0.17.1-1
- new maintenance release 0.17.1:
  https://beaker-project.org/docs/whats-new/release-0.17.html#beaker-0-17-1

* Wed Jun 11 2014 Dan Callaghan <dcallagh@redhat.com> - 0.17.0-1
- new release 0.17.0:
  https://beaker-project.org/releases/#beaker-0.17
  https://beaker-project.org/docs/whats-new/release-0.17.html

* Thu Apr 17 2014 Dan Callaghan <dcallagh@redhat.com> - 0.16.2-1
- new maintenance release 0.16.2:
  http://beaker-project.org/docs/whats-new/release-0.16.html#beaker-0-16-2

* Wed Mar 26 2014 Dan Callaghan <dcallagh@redhat.com> - 0.16.1-1
- new maintenance release 0.16.1:
  http://beaker-project.org/docs/whats-new/release-0.16.html#beaker-0-16-1

* Mon Mar 17 2014 Dan Callaghan <dcallagh@redhat.com> - 0.16.0-2
- a number of build fixes

* Fri Mar 14 2014 Dan Callaghan <dcallagh@redhat.com> - 0.16.0-1
- new release 0.16.0:
  http://beaker-project.org/releases/#beaker-0.16.0
  http://beaker-project.org/docs/whats-new/release-0.16.html

* Tue Feb 25 2014 Dan Callaghan <dcallagh@redhat.com> - 0.15.5-1
- new maintenance release 0.15.5:
  http://beaker-project.org/docs/whats-new/release-0.15.html#beaker-0-15-5

* Mon Feb 17 2014 Dan Callaghan <dcallagh@redhat.com> - 0.15.4-1
- new maintenance release 0.15.4:
  http://beaker-project.org/docs/whats-new/release-0.15.html#beaker-0-15-4

* Mon Feb 10 2014 Nick Coghlan <ncoghlan@redhat.com> 0.15.3-2
- 1062529 pass --update to createrepo (dcallagh)
- 1063090 beah_rpm ks_meta variable to force beah version (dcallagh)

* Fri Jan 31 2014 Nick Coghlan <ncoghlan@redhat.com> 0.15.3-1
- new maintenance release 0.15.3:
  http://beaker-project.org/docs/whats-new/release-0.15.html#beaker-0-15-3

* Wed Dec 18 2013 Amit Saha <asaha@redhat.com> 0.15.2-1
- new maintenance release 0.15.2:
  http://beaker-project.org/docs/whats-new/release-0.15.html#beaker-0-15-2

* Fri Nov 29 2013 Dan Callaghan <dcallagh@redhat.com> 0.14.4-1
- downgraded to 0.14.4 maintenance release:
  http://beaker-project.org/docs/whats-new/release-0.14.html#beaker-0-14-4

* Mon Nov 25 2013 Dan Callaghan <dcallagh@redhat.com> 0.15.1-2
- fix spec conditional for python-simplejson Requires

* Mon Nov 18 2013 Dan Callaghan <dcallagh@redhat.com> 0.15.1-1
- upstream bug fix release 0.15.1
  http://beaker-project.org/docs/whats-new/release-0.15.html#beaker-0-15-1

* Thu Nov 14 2013 Raymond Mancy <rmancy@redhat.com> 0.14.3-1
- new maintenance release 0.14.3:
  http://beaker-project.org/releases/#beaker-0.14.3
  http://beaker-project.org/docs/whats-new/release-0.14.html#beaker-0-14-3

* Fri Nov 01 2013 Raymond Mancy <rmancy@redhat.com> 0.14.2-1
- downgraded to bug fix release 0.14.2

* Mon Sep 30 2013 Dan Callaghan <dcallagh@redhat.com> 0.15.0-1
- new release 0.15.0:
  http://beaker-project.org/releases/#beaker-0.15.0
...
* Wed Mar 23 2011 Raymond Mancy <rmancy@redhat.com> 0.6.7-1
...
* Wed Feb 09 2011 Dan Callaghan <dcallagh@redhat.com> 0.6.4-2
...
* Thu Dec 09 2010 Raymond Mancy <rmancy@redhat.com> 0.6.0-1
...
* Wed Jun 23 2010 Bill Peck <bpeck@redhat.com> - 0.5.45-1
- fix string compare

* Tue Jun 22 2010 Bill Peck <bpeck@redhat.com> - 0.5.45-0
...
* Tue Sep 29 2009 Bill Peck <bpeck@redhat.com> - 0.4.45-0
